...
w1 = GameSprite('стена1.png',win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite('стена1.png', 370, 100, 50, 400)
...
#создаем спрайты
packman = Player('pacmanhero.png', 5, win_height - 80, 80, 80, 0, 0)
...
final_sprite = GameSprite('finish.png', win_width - 100, win_height - 80, 80, 80)
